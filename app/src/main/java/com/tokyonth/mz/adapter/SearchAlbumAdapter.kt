...
class SearchAlbumAdapter : AlbumPictureAdapter<ItemSearchAlbumBinding>() {
    ...
    override fun itemBind(parent: ViewGroup, viewType: Int): ItemSearchAlbumBinding {
        return ItemSearchAlbumBinding.inflate(LayoutInflater.from(parent.context))
    }

    @SuppressLint("SetTextI18n")
    override fun convert(
        data: AlbumPictureEntity, holder:
        BaseViewHolder<ItemSearchAlbumBinding>
    ) {
